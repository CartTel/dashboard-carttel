...
export function DropoffWarehouse({ onClose, id }: DropoffWarehouseProps) {
    ...
    const handleDropoffWarehouse = async (e: React.FormEvent<HTMLFormElement>) => {
        e?.preventDefault();
        setLoading(true);
        setError("");
        setSuccessMessage("");
    ...
    return (
        <form
            onSubmit={handleDropoffWarehouse}
            ...
            <div className="text-center w-full">
                <SecondaryText className="mb-[23px]">handleDropoffWarehouse</SecondaryText>
            </div>
