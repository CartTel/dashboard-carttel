...
export function PayInvoice({ onClose, id }: PayInvoiceProps) {
    ...
    return (
        <form
            ...
            <div className="text-center w-full">
                <SecondaryText className="mb-[23px]">Pay Invoice</SecondaryText>
            </div>
                    ...
                    <div>
                        {loading ? ( // Display spinner if userLoading is true
                            ...
                            <div className='flex items-center justify-center text-[13px]'>
                                ...
                                <span className="ml-0">Approve Payment</span>
                            </div>
                        )}
