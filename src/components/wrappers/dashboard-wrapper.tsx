                ...
                <div className="relative ">
                  <button>
                    ...
                    <div className="rounded-full h-[10px] w-[10px] bg-red-600 top-0 absolute left-4 text-white p-[10px] flex justify-center items-center">
                      <span className="text-white text-[10px] px-[2px] py-[2px]">
                        5
                      </span>
                    </div>
                  </button>
            ...
            <div className="flex items-center gap-[8px]">
              <div onClick={() => setOpen(true)}>
                ...
                <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
                  ...
                  >
                    <div className="flex items-center lg:hidden rounded p-2 mr-2 text-secondary text-2xl">
                      <svg
                    ...
                    {links.map(({ Icon, ActiveIcon, label, link }, i) => {
                      return (
                        <li
                          ...
                          key={i}
                          className={`mb-[5px] sidebar-item text-gray-500 rounded-[10px] w-[100%] h-[50px] px-[24px] flex items-center gap-[8px] cursor-pointer ${getCurrentPage(link)
                            ? `sidebar-active !text-[#1d4188] !bg-[#fcd25e]`
                            : `hover:text-[#1d4188] hover:bg-[#fcd25e]`
                            }`}
                        >
                          <div className="item icon">
                            <Icon />
