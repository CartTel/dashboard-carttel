...
interface ImportDashboardWrapper {
    children: React.ReactNode;
}

export function ImportDashboardWrapper({ children }: ImportDashboardWrapper) {
                            ...
                            <Link
                                ...
                                >
                                    <ul className="w-fit flex flex-col gap-5 border-b border-stroke px-2 py-2 dark:border-strokedark">
                                            ...
                                            >
                                                <div className='text-xs'>
                                                    ...
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M12.1596 10.87C12.0596 10.86 11.9396 10.86 11.8296 10.87C9.44957 10.79 7.55957 8.84 7.55957 6.44C7.55957 3.99 9.53957 2 11.9996 2C14.4496 2 16.4396 3.99 16.4396 6.44C16.4296 8.84 14.5396 10.79 12.1596 10.87Z" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M7.15973 14.56C4.73973 16.18 4.73973 18.82 7.15973 20.43C9.90973 22.27 14.4197 22.27 17.1697 20.43C19.5897 18.81 19.5897 16.17 17.1697 14.56C14.4297 12.73 9.91973 12.73 7.15973 14.56Z" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                </div>
                                        ...
                                        <li className='w-full'>
                                            <Link
                                                href="/dashboard/import/settings"
                            ...
                            {SIDEBAR.map(({ title, links }, index) => (
                                <div key={index}>
                                    <div className="px-[24px] my-[18px]">
                                        {title && (
                                            <BodySmallestMedium className="uppercase text-gray-500">
                                                {title}
                                            </BodySmallestMedium>
                                        )}
                                    </div>
                                        ...
                                        {links.map(({ Icon, ActiveIcon, label, link }, i) => {
                                            return (
                                                <li
                                                    ...
                                                    key={i}
                                                    className={`mb-[5px] sidebar-item text-gray  rounded-[10px] w-[100%] hover:text-[#1d4188] hover:bg-[#fcd25e] h-[50px] px-[24px] flex items-center gap-[8px] ${getCurrentPage(link)
                                        ...
                                        {links.map(({ Icon, ActiveIcon, label, link }, i) => {
                                            return (
                                                <li
                                                    ...
                                                    key={i}
                                                    className={`mb-[5px] sidebar-item text-gray rounded-[10px] w-[100%] h-[50px] px-[24px] flex items-center gap-[8px] cursor-pointer ${getCurrentPage(link) ? `sidebar-active !text-[#1d4188] !bg-[#fcd25e]` : `hover:text-[#1d4188] hover:bg-[#fcd25e]`}`}
                                                >
                                                    <div className='item icon'>
                                                        <Icon
                                                        />
