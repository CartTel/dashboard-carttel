...
import { createProcurementRequest } from "@/config/api";
    ...
    return (
        <div className="text-lg  w-full z-0 relative">
            ...
            <div className="my-[20px] flex lg:items-center justify-between lg:flex-row flex-col mb-[0px]">
                <H1 className="">Create Procurement</H1>
            </div>
                            ...
                            <div>
                                                ...
                                                <div className=" grid items-center pb-5 lg:grid-cols-3 md:grid-cols-1 xs:gap-5 md:gap-5">
                                                    ...
                                                    {/* <div className={`form-group flex w-[100%] text-[1rem] mt-2`}>
                                                        ...
                                                        <CustomInput
                                                            ...
                                                            value={item.value || ""}
                                                            onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) =>
                                                                handleItemChange(index, 'websiteChoice', e.target.value)
                                                            }
                                ...
                                {/* <div className="flex justify-between pb-10 w-full">
                                    ...
                                    <div className="flex w-full">
                                        <div className="flex justify-end z-10 relative mt-4 mr-3 w-full">
                                            <button
                                    ...
                                    <div>
                                        {loading ? ( // Display spinner if userLoading is true
                                            ...
                                            <div className='flex items-center justify-center text-[13px]'>
                                                <span className="ml-0">Create Procurement</span>
                                            </div>
                                        )}
                                    </div>
                                </CustomButton>
