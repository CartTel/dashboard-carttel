                    ...
                    <div>
                        <div className="flex md:flex-row xs:flex-col gap-10 my-10">
                            <div className={`form-group flex w-[100%] text-[1rem] my-0`}>
                                <CustomInput
                                    id="tracking_id"
                                    name="tracking.tracking_id" // Updated name to match nested property
                                    type="text"
                                    label="Tracking ID"
                                    required
                                    showRequirement={true}
                                    value={formData?.tracking?.tracking_id}
                            ...
                            <div className={`form-group flex w-[100%] text-[1rem] my-0`}>
                                <CustomInput
                                    id="tracking_url"
                                    name="tracking.tracking_url" // Updated name to match nested property
                                    type="text"
                                    label="Tracking URL"
                                    required
                                    showRequirement={true}
                                    value={formData?.tracking?.tracking_url}
                                    onChange={handleTrackingChange}
                                    className="px-0 mb-[5px] md:w-full xs:w-full text-[16px]"
                                />
                            </div>
                            <div className={`form-group flex w-[100%] text-[1rem] my-0`}>
                                <CustomInput
                                    id="tracking_number"
                                    name="tracking.tracking_number" // Updated name to match nested property
                                    type="text"
                        ...
                        <div className="flex md:flex-row xs:flex-col gap-10 my-10">
                            <div className={`form-group flex w-[100%] text-[1rem] my-0`}>
                                <CustomInput
                                    ...
                                    name="tracking.third_party_tracking_id" // Updated name to match nested property
                                    type="text"
                                    label="Third Party Tracking ID"
                                    required
                                    showRequirement={true}
                                    value={formData?.tracking?.third_party_tracking_id}
                                    onChange={handleTrackingChange}
                                    className="px-0 mb-[5px] md:w-full xs:w-full text-[16px]"
                                />
                            </div>
                            <div className={`form-group flex w-[100%] text-[1rem] my-0`}>
                                <CustomInput
                                    ...
                                    name="tracking.third_party_tracking_name" // Updated name to match nested property
                                    type="text"
                                    label="Third Party Tracking Number"
                                    required
                                    showRequirement={true}
                                    value={formData?.tracking?.third_party_tracking_name}
                                    onChange={handleTrackingChange}
                                    className="px-0 mb-[5px] md:w-full xs:w-full text-[16px]"
                                />
                            </div>
