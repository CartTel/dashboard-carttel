                    ...
                    <div className='w-full grid lg:grid-cols-3 md:grid-cols-2 xs:grid-cols-1 gap-4 mt-10'>
                        ...
                        <div className='rounded-lg border-[1px] border-gray-400 py-2 bg-[#1d428a]'>
                            ...
                            <div className='px-4'>
                                ...
                                <button
                                    ...
                                    className='bg-[#fbc421] text-center text-slate-800 font-medium my-2 border-transparent border-[2px] w-full rounded-lg px-2 py-3'
                                >
                                    Get Started
                                </button>
                        ...
                        <div className='rounded-lg border-[1px] border-gray-400 py-2 px-4'>
                            ...
                            <button
                                ...
                                className='text-center text-slate-800 font-medium my-2 border-gray-200 border-[2px] w-full rounded-lg px-2 py-3'
                            >
                                Get Started
                            </button>
