...
export function PickupPage() {
    const [pickupSet, setPickupSet] = useState("Current Pickup");
    const [isOpen, setIsOpen] = useState(false);

    const [scheduled, setScheduled] = useState<any>(initialState);

    // eslint-disable-next-line no-unused-vars
    const [pickupNaming, setPickupNaming] = useState({
        nameOne: "Current Pickup",
        nameTwo: "Pickup History",
    });
    ...
    return (
        <div className="text-lg  w-full z-0 relative">
            ...
            <div className="my-20">
                ...
                <div
                    className={`${pickupSet === pickupNaming.nameOne ||
                        pickupNaming.nameTwo
                        ? ""
                        : ""
                ...
                >
                    <div className="w-full flex justify-center items-center ">
                        <div className="text-center grid grid-cols-2 justify-between md:w-[100%] xs:w-full text-sm border-none outline-none">
                            <h1
                                className={`${pickupSet === pickupNaming.nameOne ? "border-t-[2px] border-secondary bg-gray-100" : ""
                                    } py-4 flex items-center md:pr-0 pr-5 group w-full `}
                                onClick={() => {
                                    pickupSet !== pickupNaming.nameOne
                                        ? setPickupSet(pickupNaming.nameOne)
                                        : setPickupSet(pickupNaming.nameOne);
                            ...
                            >
                                <div className="flex justify-center items-center w-full text-xs">
                                    <div className="flex md:mr-1 xs:mr-0 h-5 w-5 justify-center">
                                        <div className="md:text-xl xs:text-3xl flex mr-1 w-10 h-10 justify-center text-gray-600"><TiCalendarOutline /></div>
                                    </div>
                                    <div className="md:flex xs:hidden justify-center items-center text-center text-gray-600">
                                        {pickupNaming.nameOne}
                                    </div>
                            ...
                            <h1
                                className={`${pickupSet === pickupNaming.nameTwo ? "border-t-[2px] border-secondary bg-gray-100" : ""
                                    } py-4 flex items-center md:pr-0 pr-5 group w-full `}
                                onClick={() => {
                                    pickupSet !== pickupNaming.nameTwo
                                        ? setPickupSet(pickupNaming.nameTwo)
                                        : setPickupSet(pickupNaming.nameTwo)
                                        ...
                                        <div className='flex flex-col bg-transparent justify-center items-center my-8 rounded-lg xs:px-5 md:px-20'>
                                            ...
                                            <div className='font-medium md:text-lg xs:text-md my-5 w-full'>
                                                ...
                                                <div className='text-gray-500 font-medium w-full md:text-[13px] xs:text-xs flex justify-center items-center my-5 text-center'>
                                                    There is currently no pickup appointments made yet to show. <br />Once you schedule some appointments, they would appear here.
                                                </div>
                                            </div>
