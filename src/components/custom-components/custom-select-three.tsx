...
export function CustomSelectThree({valued, setValued, options, label, setSelected, selected, wrapperClass, optionWrapperClass, optionsClass, required }: ICustomSelect) {
            ...
            <div className="flex w-full justify-between">
                <div className=" w-full">
                    <input
                        ...
                        className="border-none text-[1rem] w-full outline-none bg-transparent focus:bg-transparent"
                        placeholder={label}
                    />
                </div>
                ...
                <B1 className={`${selected ? 'flex' : 'hidden'} text-gray text-[1rem]`}>{selected ? options.find(o => o.value === selected)?.label : ""}</B1>
            </div>
